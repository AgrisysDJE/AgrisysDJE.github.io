...
/* harmony import */ var _Services_Firebase_Pens__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(119);
/* harmony import */ var _Services_utils_handleError__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34);
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _utils_handleError__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34);
/* harmony import */ var _Initial__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(37);
...
/* harmony import */ var _utils_handleError__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34);
/* harmony import */ var _Initial__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(37);
/* harmony import */ var _Services_utils_defines__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(31);
...
"use strict";
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(92);
...
"use strict";
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
...
/* harmony import */ var _Navigators_Root__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36);
...
"use strict";
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(92);
/* harmony default export */ __webpack_exports__["a"] = ({initialState:{},action:Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__["createAction"])('theme/setDefaultTheme'),reducers:function reducers(state,_ref){var payload=_ref.payload;if(!state.theme){state.theme=payload.theme;}}});
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _utils_handleError__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34);
/* harmony import */ var _Initial__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(37);
/* harmony import */ var _utils_formators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(87);
...
var Section = __webpack_require__(128);
...
var Pens = __webpack_require__(119);
...
var DefaultTheme = __webpack_require__(155);
...
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(92);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(311);
/* harmony import */ var _Services_Firebase_Utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(133);
/* harmony import */ var _Services_utils_handleError__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(34);
/* harmony import */ var _Services_utils_defines__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(31);
...
var defines = __webpack_require__(31);

// EXTERNAL MODULE: C:/Users/daniel/Desktop/AgrisysApp/src/Store/Firebase/Utils.js
var Utils = __webpack_require__(35);

// EXTERNAL MODULE: C:/Users/daniel/Desktop/AgrisysApp/src/Store/Firebase/Weighing.js + 1 modules
var Firebase_Weighing = __webpack_require__(81);
...
var Firebase_Utils = __webpack_require__(133);
...
var Linking = __webpack_require__(179);
...
var redux_toolkit_esm = __webpack_require__(92);
...
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly){symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});}keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){defineProperty_default()(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}function fetch(_x,_x2){return _fetch.apply(this,arguments);}function _fetch(){_fetch=asyncToGenerator_default()(regenerator_default.a.mark(function _callee6(_ref,_rend){var FarmId,PenId,SectionId,_ref$limitStart,limitStart,_ref$limitTo,limitTo,DataTime,MemSections,ref,res,state,te,newWeights;return regenerator_default.a.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:FarmId=_ref.FarmId,PenId=_ref.PenId,SectionId=_ref.SectionId,_ref$limitStart=_ref.limitStart,limitStart=_ref$limitStart===void 0?0:_ref$limitStart,_ref$limitTo=_ref.limitTo,limitTo=_ref$limitTo===void 0?9999:_ref$limitTo,DataTime=_ref.DataTime,MemSections=_ref.MemSections;if(!FarmId){_context6.next=22;break;}ref="farms_data/"+FarmId+"/weighings";if(!PenId){_context6.next=15;break;}console.log("Weight fetch called, getting Pen");ref+="/"+PenId;res=defineProperty_default()({},PenId,{});state=_rend.getState();if(state.firebase.weighings){res=_objectSpread({},state.firebase.weighings);}_context6.next=11;return Object(Initial["b" /* database */])().ref(ref).orderByChild('time').limitToLast(limitTo).once('value',function(){var _ref2=asyncToGenerator_default()(regenerator_default.a.mark(function _callee(snapshot){return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:res[snapshot.key]={};snapshot.forEach(function(c){res[snapshot.key][c.key]=c.val();});case 2:case"end":return _context.stop();}}},_callee);}));return function(_x9){return _ref2.apply(this,arguments);};}()).catch(function(error){console.log(error);return Object(handleError["a" /* default */])({message:'Fecth Weights Error'});});case 11:te=_context6.sent;return _context6.abrupt("return",res);case 15:console.log("Weight fetch called, getting Sections");newWeights={};_context6.next=19;return Object(Firebase_Sections["a" /* fetch */])({FarmId:FarmId}).then(function(){var _ref3=asyncToGenerator_default()(regenerator_default.a.mark(function _callee5(sections){var Sections;return regenerator_default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:Sections=sections?sections:MemSections;_context5.next=3;return Promise.all(Object.entries(Sections).map(function(){var _ref4=asyncToGenerator_default()(regenerator_default.a.mark(function _callee4(_ref5){var _ref6,section,data;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_ref6=slicedToArray_default()(_ref5,2),section=_ref6[0],data=_ref6[1];if(!(data&&data.pens)){_context4.next=4;break;}_context4.next=4;return Promise.all(Object.entries(data.pens).map(function(){var _ref7=asyncToGenerator_default()(regenerator_default.a.mark(function _callee3(_ref8){var _ref9,pen,data;return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_ref9=slicedToArray_default()(_ref8,2),pen=_ref9[0],data=_ref9[1];if(!(pen!=="update_time")){_context3.next=4;break;}_context3.next=4;return fetch({FarmId:FarmId,PenId:pen,limitStart:0,limitTo:limitTo},_rend).then(function(){var _ref10=asyncToGenerator_default()(regenerator_default.a.mark(function _callee2(weights){return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:if(Object.keys(weights[Object.keys(weights)[0]]).length>0){newWeights=_objectSpread(_objectSpread({},newWeights),weights);}case 1:case"end":return _context2.stop();}}},_callee2);}));return function(_x13){return _ref10.apply(this,arguments);};}()).catch(function(error){console.log(error);});case 4:case"end":return _context3.stop();}}},_callee3);}));return function(_x12){return _ref7.apply(this,arguments);};}()));case 4:case"end":return _context4.stop();}}},_callee4);}));return function(_x11){return _ref4.apply(this,arguments);};}()));case 3:case"end":return _context5.stop();}}},_callee5);}));return function(_x10){return _ref3.apply(this,arguments);};}()).catch(function(error){console.log(error);return Object(handleError["a" /* default */])({message:'Fecth Weights Error'});});case 19:if(!(Object.keys(newWeights).length>0)){_context6.next=22;break;}newWeights.update_time=Date.now();return _context6.abrupt("return",newWeights);case 22:return _context6.abrupt("return",Object(handleError["a" /* default */])({message:'Fecth Weights Error'}));case 23:case"end":return _context6.stop();}}},_callee6);}));return _fetch.apply(this,arguments);}function create(_x3,_x4){return _create.apply(this,arguments);}function _create(){_create=asyncToGenerator_default()(regenerator_default.a.mark(function _callee8(_ref11,_rend){var FarmId,PenId,Data,ref,weightRef,weightId,res;return regenerator_default.a.wrap(function _callee8$(_context8){while(1){switch(_context8.prev=_context8.next){case 0:FarmId=_ref11.FarmId,PenId=_ref11.PenId,Data=_ref11.Data;if(!FarmId){_context8.next=15;break;}ref="farms_data/"+FarmId+"/weighings";if(!PenId){_context8.next=15;break;}ref+="/"+PenId+"/";_context8.next=7;return Object(Initial["b" /* database */])().ref(ref).push();case 7:weightRef=_context8.sent;weightId=weightRef.key;_context8.next=11;return weightRef.set(_objectSpread({},Data)).then(asyncToGenerator_default()(regenerator_default.a.mark(function _callee7(){var res2;return regenerator_default.a.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:_context7.next=2;return fetch({FarmId:FarmId,PenId:PenId,DataTime:"SET"},_rend).then(function(weights){return weights;});case 2:res2=_context7.sent;return _context7.abrupt("return",res2);case 4:case"end":return _context7.stop();}}},_callee7);}))).catch(function(error){console.log("Create Weight Error: ",error);return Object(handleError["a" /* default */])({message:'Create Weight Error'});});case 11:res=_context8.sent;return _context8.abrupt("return",res);case 15:return _context8.abrupt("return",Object(handleError["a" /* default */])({message:'Create Weights Error'}));case 16:case"end":return _context8.stop();}}},_callee8);}));return _create.apply(this,arguments);}function update(_x5,_x6){return _update.apply(this,arguments);}function _update(){_update=asyncToGenerator_default()(regenerator_default.a.mark(function _callee11(_ref13,_rend){var FarmId,PenId,WeightId,Data,ref,weightRef,weightId,res;return regenerator_default.a.wrap(function _callee11$(_context11){while(1){switch(_context11.prev=_context11.next){case 0:FarmId=_ref13.FarmId,PenId=_ref13.PenId,WeightId=_ref13.WeightId,Data=_ref13.Data;if(!FarmId){_context11.next=14;break;}ref="farms_data/"+FarmId+"/weighings";if(!PenId){_context11.next=14;break;}ref+="/"+PenId+"/";if(!WeightId){_context11.next=14;break;}_context11.next=8;return Object(Initial["b" /* database */])().ref(ref).push();case 8:weightRef=_context11.sent;weightId=weightRef.key;_context11.next=12;return weightRef.set(_objectSpread({},Data)).then(asyncToGenerator_default()(regenerator_default.a.mark(function _callee10(){var res2;return regenerator_default.a.wrap(function _callee10$(_context10){while(1){switch(_context10.prev=_context10.next){case 0:ref+="/"+WeightId;_context10.next=3;return Object(Initial["b" /* database */])().ref(ref).update({edited:weightId}).then(asyncToGenerator_default()(regenerator_default.a.mark(function _callee9(){var res3;return regenerator_default.a.wrap(function _callee9$(_context9){while(1){switch(_context9.prev=_context9.next){case 0:_context9.next=2;return fetch({FarmId:FarmId,PenId:PenId,DataTime:"SET"},_rend).then(function(weights){return weights;});case 2:res3=_context9.sent;return _context9.abrupt("return",res3);case 4:case"end":return _context9.stop();}}},_callee9);}))).catch(function(error){console.log("Delete Weight Error: ",error);Object(handleError["a" /* default */])({message:'Delete Weights Error'});});case 3:res2=_context10.sent;return _context10.abrupt("return",res2);case 5:case"end":return _context10.stop();}}},_callee10);}))).catch(function(error){console.log("Update Weight Error: ",error);return Object(handleError["a" /* default */])({message:'Update Weight Error'});});case 12:res=_context11.sent;return _context11.abrupt("return",res);case 14:return _context11.abrupt("return",Object(handleError["a" /* default */])({message:'Update Weights Error'}));case 15:case"end":return _context11.stop();}}},_callee11);}));return _update.apply(this,arguments);}function _delete(_x7,_x8){return _delete2.apply(this,arguments);}function _delete2(){_delete2=asyncToGenerator_default()(regenerator_default.a.mark(function _callee13(_ref16,_rend){var FarmId,PenId,WeightId,ref,res;return regenerator_default.a.wrap(function _callee13$(_context13){while(1){switch(_context13.prev=_context13.next){case 0:FarmId=_ref16.FarmId,PenId=_ref16.PenId,WeightId=_ref16.WeightId;if(!FarmId){_context13.next=11;break;}ref="farms_data/"+FarmId+"/weighings";if(!PenId){_context13.next=11;break;}ref+="/"+PenId+"/";if(!WeightId){_context13.next=11;break;}ref+="/"+WeightId;_context13.next=9;return Object(Initial["b" /* database */])().ref(ref).update({deleted:true}).then(asyncToGenerator_default()(regenerator_default.a.mark(function _callee12(){var res2;return regenerator_default.a.wrap(function _callee12$(_context12){while(1){switch(_context12.prev=_context12.next){case 0:_context12.next=2;return fetch({FarmId:FarmId,PenId:PenId,DataTime:"SET"},_rend).then(function(weights){return weights;});case 2:res2=_context12.sent;return _context12.abrupt("return",res2);case 4:case"end":return _context12.stop();}}},_callee12);}))).catch(function(error){console.log("Delete Weight Error: ",error);Object(handleError["a" /* default */])({message:'Delete Weights Error'});});case 9:res=_context13.sent;return _context13.abrupt("return",res);case 11:return _context13.abrupt("return",Object(handleError["a" /* default */])({message:'Delete Weights Error'}));case 12:case"end":return _context13.stop();}}},_callee13);}));return _delete2.apply(this,arguments);}
// CONCATENATED MODULE: C:/Users/daniel/Desktop/AgrisysApp/src/Store/Firebase/Weighing.js
/* harmony default export */ var Weighing = __webpack_exports__["a"] = ({initialState:Object(lib["buildAsyncState"])(),action:Object(lib["buildAsyncActions"])('firebase/weighings',fetch),create:Object(lib["buildAsyncActions"])('firebase/weighings',create),update:Object(lib["buildAsyncActions"])('firebase/weighings',update),_delete:Object(lib["buildAsyncActions"])('firebase/weighings',_delete),reducers:Object(lib["buildAsyncReducers"])({itemKey:'weighings',errorKey:'error',loadingKey:'loading'})});
...
// EXTERNAL MODULE: C:/Users/daniel/Desktop/AgrisysApp/src/Services/Firebase/Pens.js
var Firebase_Pens = __webpack_require__(119);

// CONCATENATED MODULE: C:/Users/daniel/Desktop/AgrisysApp/src/Services/Firebase/Batchs.js
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly){symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});}keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){defineProperty_default()(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}function fetch(_x,_x2){return _fetch.apply(this,arguments);}function _fetch(){_fetch=asyncToGenerator_default()(regenerator_default.a.mark(function _callee(_ref,_rend){var FarmId,BatchId,Data,DataTime,ref,res;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:FarmId=_ref.FarmId,BatchId=_ref.BatchId,Data=_ref.Data,DataTime=_ref.DataTime;if(!FarmId){_context.next=31;break;}ref="farms_data/"+FarmId+"/batchs";if(BatchId){ref+="/"+BatchId;}if(Data){_context.next=10;break;}_context.next=7;return Object(Initial["b" /* database */])().ref(ref).once('value').then(function(_batchdata){if(BatchId){var batchdata=_batchdata.val();if(!batchdata)return null;if(!batchdata.datas)batchdata.datas={};if(!batchdata.pens)batchdata.pens=[];if(!batchdata.datas.gcurve)batchdata.datas.gcurve="default";var batch=defineProperty_default()({},BatchId,batchdata);var state=_rend.getState();if(state.firebase.batchs){batch=_objectSpread({},state.firebase.batchs);batch[BatchId]=batchdata;}return batch;}else{return _batchdata.val();}});case 7:res=_context.sent;_context.next=29;break;case 10:if(!BatchId){_context.next=29;break;}_context.t0=Data;_context.next=_context.t0===defines["a" /* DataRefs */].BATCHS?14:_context.t0===defines["a" /* DataRefs */].PENS?19:_context.t0===defines["a" /* DataRefs */].GRAPH?24:29;break;case 14:ref+="/"+"datas";_context.next=17;return Object(Initial["b" /* database */])().ref(ref).once('value').then(function(_batchdata){var data=defineProperty_default()({},BatchId,{datas:_batchdata.val()});return data;});case 17:res=_context.sent;return _context.abrupt("break",29);case 19:ref+="/"+"pens";_context.next=22;return Object(Initial["b" /* database */])().ref(ref).once('value').then(function(_batchdata){var pens=defineProperty_default()({},BatchId,{pens:_batchdata.val()});return pens;});case 22:res=_context.sent;return _context.abrupt("break",29);case 24:ref+="/"+"gcurve";_context.next=27;return Object(Initial["b" /* database */])().ref(ref).once('value').then(function(_batchdata){var curve=defineProperty_default()({},BatchId,{gcurve:_batchdata.val()});return curve;});case 27:res=_context.sent;return _context.abrupt("break",29);case 29:if(!res){_context.next=31;break;}return _context.abrupt("return",res);case 31:return _context.abrupt("return",Object(handleError["a" /* default */])({message:'Fecth Batchs Error'}));case 32:case"end":return _context.stop();}}},_callee);}));return _fetch.apply(this,arguments);}function update(_x3,_x4){return _update.apply(this,arguments);}function _update(){_update=asyncToGenerator_default()(regenerator_default.a.mark(function _callee4(_ref2,_rend){var FarmId,BatchId,Data,ref,res;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:FarmId=_ref2.FarmId,BatchId=_ref2.BatchId,Data=_ref2.Data;if(!FarmId){_context4.next=9;break;}ref="farms_data/"+FarmId+"/batchs";if(!(BatchId&&Data)){_context4.next=9;break;}ref+="/"+BatchId;_context4.next=7;return fetch({FarmId:FarmId,BatchId:BatchId,Data:defines["a" /* DataRefs */].PENS}).then(function(){var _ref3=asyncToGenerator_default()(regenerator_default.a.mark(function _callee3(_batch){var Pens,BatchPens,RemovedPens,NewPens,SamePens,res2;return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:Pens=_batch.data[BatchId].pens;BatchPens={};if(Data.pens&&JSON.stringify(Data.pens)!==JSON.stringify(Pens)){if(!Pens)Pens=[];RemovedPens=Object.keys(Pens).filter(function(x){return!Object.keys(Data.pens).includes(x)&&!Pens[x].enddate;});NewPens=Object.keys(Data.pens).filter(function(x){return!Object.keys(Pens).includes(x)||Pens[x].enddate;});if(RemovedPens&&RemovedPens.length>0){RemovedPens.forEach(function(pen){if(Pens[pen]){var Pen=Pens[pen];if(!Pen.enddate){Pen={};}Pen.enddate=Date.now();BatchPens[pen]=Pen;Object(Firebase_Pens["b" /* update */])({FarmId:FarmId,PenId:pen,Pen:{datas:{batch:""}}});}});}if(NewPens&&NewPens.length>0){NewPens.forEach(function(pen){var Pen=Pens[pen]?Pens[pen]:{startdate:Date.now()};if(Pen.enddate)delete Pen.enddate;BatchPens[pen]=Pen;Object(Firebase_Pens["b" /* update */])({FarmId:FarmId,PenId:pen,Pen:{datas:{batch:BatchId}}});});}SamePens=Object.keys(Pens).filter(function(x){return!RemovedPens.includes(x)&&!NewPens.includes(x);});if(SamePens&&SamePens.length>0){SamePens.forEach(function(pen){BatchPens[pen]=Pens[pen];});}}Data.pens=BatchPens;if(!(Data.state&&Data.state===defines["b" /* DataStates */].CLOSED)){_context3.next=7;break;}_context3.next=11;break;case 7:_context3.next=9;return Object(Initial["b" /* database */])().ref(ref).update(_objectSpread({},Data)).then(asyncToGenerator_default()(regenerator_default.a.mark(function _callee2(){var res3;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return fetchBatchs({FarmId:FarmId,BatchId:BatchId,DataTime:"SET"}).then(function(data){return data;});case 2:res3=_context2.sent;return _context2.abrupt("return",res3);case 4:case"end":return _context2.stop();}}},_callee2);}))).catch(function(error){if(error.code==='database/permission-denied'){console.log("Batch update was permission denied. ");}else if(error.code){console.log("Batch update Error: ",error);}console.log(error);return Object(handleError["a" /* default */])({message:'Update Batchs Error'});});case 9:res2=_context3.sent;return _context3.abrupt("return",res2);case 11:case"end":return _context3.stop();}}},_callee3);}));return function(_x7){return _ref3.apply(this,arguments);};}());case 7:res=_context4.sent;return _context4.abrupt("return",res);case 9:return _context4.abrupt("return",Object(handleError["a" /* default */])({message:'Update Batchs Error'}));case 10:case"end":return _context4.stop();}}},_callee4);}));return _update.apply(this,arguments);}function create(_x5,_x6){return _create.apply(this,arguments);}function _create(){_create=asyncToGenerator_default()(regenerator_default.a.mark(function _callee6(_ref5,_rend){var FarmId,BatchId,Data,ref,res;return regenerator_default.a.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:FarmId=_ref5.FarmId,BatchId=_ref5.BatchId,Data=_ref5.Data;if(!FarmId){_context6.next=9;break;}ref="farms_data/"+FarmId+"/batchs";if(!(BatchId&&Data)){_context6.next=9;break;}ref+="/"+BatchId;_context6.next=7;return Object(Initial["b" /* database */])().ref(ref).set(_objectSpread({},Data)).then(asyncToGenerator_default()(regenerator_default.a.mark(function _callee5(){var res2;return regenerator_default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:_context5.next=2;return Promise.all(Object.keys(Batch.pens).map(function(pen){Object(Firebase_Pens["b" /* update */])({FarmId:FarmId,PenId:pen,Pen:{datas:{batch:BatchId}}});}));case 2:_context5.next=4;return fetch({FarmId:FarmId,DataTime:"SET"});case 4:res2=_context5.sent;return _context5.abrupt("return",res2);case 6:case"end":return _context5.stop();}}},_callee5);}))).catch(function(error){if(error.code==='database/permission-denied'){console.log("Batch update was permission denied. ");}else if(error.code){console.log("Batch create Error: ",error);}return Object(handleError["a" /* default */])({message:'Create Batchs Error'});});case 7:res=_context6.sent;return _context6.abrupt("return",res);case 9:return _context6.abrupt("return",Object(handleError["a" /* default */])({message:'Create Batchs Error'}));case 10:case"end":return _context6.stop();}}},_callee6);}));return _create.apply(this,arguments);}
// CONCATENATED MODULE: C:/Users/daniel/Desktop/AgrisysApp/src/Store/Firebase/Batch.js
/* harmony default export */ var Firebase_Batch = __webpack_exports__["a"] = ({initialState:Object(lib["buildAsyncState"])(),action:Object(lib["buildAsyncActions"])('firebase/batchs',fetch),update:Object(lib["buildAsyncActions"])('firebase/batchs',update),create:Object(lib["buildAsyncActions"])('firebase/batchs',create),reducers:Object(lib["buildAsyncReducers"])({itemKey:'batchs',errorKey:'error',loadingKey:'loading'})});
...
/* harmony import */ var _Navigators_Root__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(36);
...
//# sourceMappingURL=app.dca7278a.chunk.js.map